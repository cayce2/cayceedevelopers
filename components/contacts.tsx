...
export function ContactSection() {
  ...
  return (
    <section id="contacts" className="py-16 bg-purple-50">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8">
              ...
              <div className="mt-10 pt-8 border-t border-gray-100">
                <p className="text-sm text-gray-600 text-center">{t('Or reach us directly')}:</p>
                <div className="flex justify-center mt-3">
                  <Link
                    href="mailto:cayceedevelopers@gmail.com"
                    className="inline-flex items-center px-4 py-2 rounded-full bg-purple-100 text-purple-700 hover:bg-purple-200 transition-colors"
                  >
